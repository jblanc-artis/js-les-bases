...
let jojo = 3 == 5;
let quoi;
console.log(age, note, nom, jojo, quoi);
// <===== FIN CODE =====>

// ------------------------EXO 3------------------------
// Stockez les bonnes valeurs aux variables :
...
// Vous devez passer par cette étape :
...
let nomSas = 'Artis';
let duree = 7;
let formationPro = 'développeuse DATA';
console.log(`Je participe au sas ${nomSas} pendant ${duree} semaines afin d'intégrer la formation ${formationPro}.`);
// <===== FIN CODE =====>
...
// <===== DEBUT CODE =====>
let idole = 'Margaret';
let troisiemeLettre = idole[2];
let derniereLettre = idole[idole.length - 1];
...
// <===== DEBUT CODE =====>
let myArray = [ 'bibiche', -5, 8 / 2, 3 > 22 ];
console.log(myArray);
// <===== FIN CODE =====>
...
// <===== DEBUT CODE =====>
let myData = [ [ 12, 6, 8 ], [ 44, 71, 90 ], [ 23, 54, 99 ] ];
myData[1][2] = 11;
...
// Doit apparaitre dans la console : (6) ["Rachel", "Monica", "Ross", "Chandler", "Joey", "Phoebe"]
